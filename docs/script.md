...
`Script` has an easy interface to parse raw scripts from the network or digibyted, and to extract useful information. An illustrative example (for more options check the API reference)
