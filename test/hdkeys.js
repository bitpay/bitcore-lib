...
var HDPublicKey = digibyte.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = digibyte.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(digibyte.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(digibyte.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      digibyte.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = digibyte.PublicKey.fromPoint;
      digibyte.PublicKey.fromPoint = function() {
        digibyte.PublicKey.fromPoint = unstubbed;
