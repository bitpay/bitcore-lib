...
BufferReader.prototype.peekUInt8 = function(offset) {
  var val = this.buf.readUInt8(this.pos + offset);
  return val;
};
...
BufferReader.prototype.readVector = function() {
    var count = this.readVarintNum();
    var vector = [];
    for (var i = 0; i < count; i++) vector.push(this.readVarLengthBuffer());
    return vector;
}
