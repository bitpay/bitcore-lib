...
function createPayload(payloadType) {
  switch (payloadType) {
    case RegisteredPayloadTypes.TRANSACTION_SUBTX_REGISTER:
      return new SubTxRegisterPayload();
    case RegisteredPayloadTypes.TRANSACTION_SUBTX_TRANSITION:
      return new SubTxTransitionPayload();
    case RegisteredPayloadTypes.TRANSACTION_COINBASE:
      return new CoinbasePayload();
    default:
      throw new Error('Can not create payload - Unknown special transaction type');
  }
}
