...
var TRANSACTION_SUBTX_REGISTER = require('./constants').registeredTransactionTypes.TRANSACTION_SUBTX_REGISTER;
...
SubTxRegister.prototype.toBuffer = function() {
  this.setExtraPayloadFromBuffer(SubTxRegister.serializePayload(this.blockchainUserPayload));
