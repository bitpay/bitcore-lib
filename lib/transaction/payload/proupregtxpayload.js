...
ProUpRegTxPayload.serializeJSONToBuffer = function (transitionPayload) {
  ...
  payloadBufferWriter
    ...
    .write(Buffer.from(transitionPayload.scriptPayout, 'hex').reverse())
    .write(Buffer.from(transitionPayload.inputsHash, 'hex')); // TODO: Determine whether this reverse is needed
