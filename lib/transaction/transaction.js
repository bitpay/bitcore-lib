...
/**
 * Retrieve a hexa string that can be used with digibyted's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more digibytes than the sum of the input amounts
 * @return {string}
 */
 ...
 * and a slightly fancier format recognized by digibyte.js:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a digibyte.js Address object. The
 * same is true for `script`, which can be a string or a digibyte.js Script.
 *
 ...
 *
 * // From a pay to public key hash output from digibyted's listunspent
...
/**
 * Analogous to digibyted's IsCoinBase function in transaction.h
 */
