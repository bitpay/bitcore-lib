...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.witness) {
    _.each(this.witnessData, function(data) {
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  var marker = reader.peekUInt8(0);
  var flag = reader.peekUInt8(1);
  ...
  if (this.witness) {
    this.witnessData = [];
    for (i = 0; i < sizeTxIns; i++) {
      this.witnessData.push(reader.readVector());
    }
  }
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  obj.segwit = this.segwit;
  if (this.segwit) {
    obj.witnessData = this.witnessData.map(function(ds) {
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  this.segwit = transaction.segwit;
  if (this.segwit) {
    this.witnessData = _.each(transaction.witnessData, function(d) {
      return new buffer.Buffer(d, 'hex');
    });
  }
