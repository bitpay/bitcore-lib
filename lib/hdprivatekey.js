...
HDPrivateKey.prototype.derive = function(arg, hardened, nonCompliant) {
  ...
  // Defaults to the nonCompliant derivation, for backwards compatibility
  if (_.isUndefined(nonCompliant)) {
    console.log('WARN: .derive will be removed in next Bitcore-lib releases.  Use `getChild` for BIP32 Compliant key derivation and `getNonCompliantChild` for backwards compatibility key derivation. Details at https://github.com/bitpay/bitcore-lib/pull/115')
    nonCompliant = true;
  }
